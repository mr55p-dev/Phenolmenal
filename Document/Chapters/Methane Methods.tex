These methods focus on emulating the methane steam reformation reaction. 
...
Unlike the previously mentioned catalyst supports, \ce{HAp} is irreducible; this means there is no \ce{CO} is made in the reaction unlike the other catalyst supports currently in use.
...
This reaction mechanism gives rise to no waste gases such as \ce{CO2}, but does have the issue of elemental carbon production which can lead to the degradation of the catalyst as carbon is deposited upon the catalyst surface.
...
The main catalysts in a metal catalysed reaction are nickel and iron, these are particularly useful as a partially filled \ce{ 3d} orbitals accept electrons density from the \ce{CH} bonds destabilising their bond strength as ultimately leading to the breaking of the bond.

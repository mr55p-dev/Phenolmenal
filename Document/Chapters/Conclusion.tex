...
As \ce{H2O} is inert therefore it is far safer than  \ce{CH4} which is flammable.
...
A method using  \ce{CH4} that stands out is RMP, which requires \SI{11}{\percent} of the enthalpy required for traditional steam methane reformation.
A method using  \ce{H2O} that stands out uses SOECs, which uses less energy than traditional electrolysis and can use solar thermal energy to provide a significant portion.

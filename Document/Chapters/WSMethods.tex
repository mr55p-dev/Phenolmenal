...
Acidic/alkaline amphoteric \ce{H2O} electrolytic cells operate below 100˚C \cite{Lei2019}, whereas solid oxide electrolytic cells (SOEC) operate between 700-1000˚C \cite{Schiller2019}.
...
Since one of the biggest issues facing the commercial production of \ce{H2} from \ce{H2O} is the energy consumption, with further refinement the SOEC looks like it has the most potential.
